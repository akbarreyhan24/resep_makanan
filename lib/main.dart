...
class __PageStateListState extends State<_PageList> {
  ...
  List<String> subJudul = [
    "Nasi Goreng membutuhkan waktu 30 menit untuk memasaknya",
    "Soto Betawi membutuhkan waktu 20 menit untuk memasaknya",
    "Soto Mie Bogor membutuhkan waktu 10 menit untuk memasaknya",
    "Rendang membutuhkan waktu 6 jam  untuk memasaknya",
    "Gudeg membutuhkan waktu 1 hari  untuk memasaknya",
    "Sop Buntut membutuhkan waktu 2 jam untuk memasaknya",
    "Pempek membutuhkan waktu 10 menit untuk memasaknya",
    "Kerak Telor membutuhkan waktu 20 menit untuk memasaknya",
    "Rawon membutuhkan waktu 2 - 3 jam untuk memasaknya",
    "Sate membutuhkan waktu 15 menit untuk memasaknya"
  ];
  List<String> gambar = [
    "assets/images/nasgor.jpeg",
    "assets/images/soto_betawi.jpeg",
    "assets/images/soto_bogor.jpeg",
    "assets/images/rendang.jpeg",
    "assets/images/gudeg.jpeg",
    "assets/images/sop_buntut.jpeg",
    "assets/images/pempek.jpeg",
    "assets/images/kerak_telor.jpeg",
                ...
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(
                      builder: (context)  => DetailPage(itemJudul: title,
                          itemSub: subTitle, qty: jumlah,  itemBahan: bahan, itemCara: cara,itemImage: img, )
                  ));
                }
            ),
          );
